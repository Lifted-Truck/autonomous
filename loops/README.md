...
Two loops, one entry format, self-similar at every level.

- **Leaf knowledge loop** (per-project): canonical here at
...
see [DESIGN.md §5](../DESIGN.md) and
[research/2026-07-10-memory-governance.md](../research/2026-07-10-memory-governance.md).

Fleet extension (per DESIGN §4b): tier ladder grows a third rung —
`candidate` (organ) → `canonical` (organ) → `proliferated` (fleet,
curator-only grant); reflection is hook-enforced in autonomous mode, never
voluntary.
